========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ClickReporter
========================================================================


AppWizard が生成した ClickReporter には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ClickReporter を構成している各ファイルの概要説明が含まれています。
...
ClickReporter.h
    ...
    みます） をインクルードし、また CClickReporterApp アプリケーションクラスを宣
    言します。

ClickReporter.cpp
    このファイルは CClickReporterApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ClickReporter.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル ClickReporter.rc によってインクルード
    されます。

res\ClickReporter.rc2
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、ClickReporter.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

ClickReporterDoc.h, ClickReporterDoc.cpp - ドキュメント
    これらのファイルは CClickReporterDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CClickReporterDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

ClickReporterView.h, ClickReporterView.cpp - ビュー
    これらのファイルは CClickReporterView クラスを含みます。
    CClickReporterView オブジェクトは CClickReporterDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ClickReporter.pch 
